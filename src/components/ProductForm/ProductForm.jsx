...
function ProductForm() {
    ...
    return (
        ...
        >
            <Form.Control type="text" size="sm" id="name" name="name" pattern="[A-Z][a-z]\i" placeholder="Product name here" onChange={handleChange} required/>
        ...
        <FloatingLabel
            ...
            className="mb-3 text-dark"
        >
            <Form.Control type="number" id="price" name="price" pattern="[\d]+[.]+[\d]{0,2}" placeholder="Price here" onChange={handleChange} required/>
            <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
